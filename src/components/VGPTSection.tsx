  ...
  return (
    <div className="bg-gradient-to-b from-[#15162c] to-blue-500 py-16 text-white">
      <div className="container mx-auto px-4 text-center">
        ...
        {/* System Requirements */}
        <div className="mb-12">
          <h3 className="mb-6 text-3xl font-semibold text-amber-300">
            System Requirements
          </h3>
          <div className="mx-auto max-w-4xl text-left">
            <div className="grid gap-6 md:grid-cols-2">
              <div className="rounded-lg border border-violet-700/40 bg-violet-900/10 p-6">
                <h4 className="mb-3 text-xl font-semibold text-violet-200">
...
const GetStartedBlock = () => {
  return (
    <div className="mx-auto mt-10 flex w-full items-center rounded-xl bg-[#222448] p-4 shadow-md md:w-4/5 lg:w-3/4">
      <h3 className="mb-0 transform text-xl text-violet-100">
        Unlock the potential of Sirius Scan today!
      </h3>
      <div className="ml-auto">
        <a
          href="https://github.com/SiriusScan/Sirius"
          className="mx-2 font-extralight text-violet-100 no-underline hover:cursor-pointer"
        >
          <button className="rounded-xl border border-violet-100/50 px-4 py-2 text-lg hover:border hover:bg-violet-100 hover:text-[#222448] hover:shadow-md hover:shadow-violet-100/50">
  ...
  const topicAreas = [
    {
      title: "Ease of Use",
      description:
        "Sirius Scan features a user-friendly interface and easy setup, allowing you to start scanning your network for vulnerabilities quickly and efficiently.",
      icon: <EaseOfUseIcon />,
    },
    {
      title: "Documentation",
      description:
        "Comprehensive documentation helps you get started with Sirius Scan and guides you through its various features and capabilities.",
      icon: <DocumentationIcon />,
    },
    {
      title: "Community",
      description:
        "As an open-source project, Sirius Scan is backed by an active community of security professionals and developers who continuously work on enhancing the tool.",
      icon: <CommunityIcon />,
    },
  ];
