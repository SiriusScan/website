      ...
      <div className="relative">
        ...
        <div className="relative z-10">
          ...
          >
            ...
            <path
              className={wolfColor === "white" ? "text-white" : ""}
              fill={wolfColor !== "white" ? wolfColor : undefined}
            ...
            {/* Circuits pulse with cyan - steady animation */}
            <path
              fill={starColor || "rgba(6, 182, 212, 0.9)"}
              style={{
          ...
          {stars.map((star, i) => (
            ...
            >
              <circle
                cx={
                  Math.round(
                    Math.cos((star.angle * Math.PI) / 180) * star.radius * 100,
                  ) / 100
                }
                cy={
                  Math.round(
                    Math.sin((star.angle * Math.PI) / 180) * star.radius * 100,
                  ) / 100
                }
                r={star.size}
                fill={starColor || "rgba(251, 146, 60, 0.9)"}
                style={{
