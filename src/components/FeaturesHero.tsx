        ...
        <div className="grid items-center justify-center gap-8 md:grid-cols-5">
          ...
          <div className="md:col-span-3 md:px-24">
            ...
            <p className="mb-8 text-xl font-light text-violet-100">
              ...
              affect it. Good penetration testers and vulnerability assessors
              look for attack surface and opportunity. Sirius Scan presents you
              a data-first view of the environment that empowers the operator
              directly.
            </p>
            <Link
              href="https://github.com/SiriusScan/Sirius"
              className="inline-block rounded-md border border-violet-200 px-16 py-2 text-white transition duration-300 hover:bg-white hover:text-violet-500 hover:shadow-lg"
            >
              Learn More
            </Link>
          </div>
