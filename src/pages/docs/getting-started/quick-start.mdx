...
3. **Repository Setup**
   ...
   git remote -v
   # Should show: https://github.com/SiriusScan/Sirius.git
   ```
...
1. **UI Access**: Navigate to http://localhost:3000
2. **Login**: Use default credentials (admin/password)
3. **Dashboard**: Verify dashboard loads without errors
4. **Navigation**: Test main menu navigation
5. **Settings**: Access and verify settings panels
...
- Explore the [Docker architecture documentation](https://github.com/SiriusScan/Sirius/blob/main/documentation/README.architecture.md)
