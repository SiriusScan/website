...
function renderVideoNodeToDOM(node, options = {}) {
    ...
    const htmlString = options.target === 'email'
        ? emailCardTemplate$1({node, options, cardClasses})
        : cardTemplate$1({node, cardClasses});
...
function cardTemplate$1({node, cardClasses}) {
...
function emailCardTemplate$1({node, options, cardClasses}) {
    const thumbnailSrc = node.getCustomThumbnailSrc() || node.getThumbnailSrc();
